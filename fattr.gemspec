...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE".freeze, "README.erb".freeze, "Rakefile".freeze, "lib/fattr.rb".freeze, "lib/fattr/attribute.rb".freeze, "lib/fattr/attribute_parser.rb".freeze, "lib/fattr/attribute_set.rb".freeze, "lib/fattr/globally.rb".freeze, "lib/fattr/version.rb".freeze, "lib/old_fattr.rb".freeze, "samples/a.rb".freeze, "samples/b.rb".freeze, "samples/c.rb".freeze, "samples/d.rb".freeze, "samples/e.rb".freeze, "samples/f.rb".freeze, "samples/g.rb".freeze, "samples/h.rb".freeze, "samples/i.rb".freeze, "test/fattr_test.rb".freeze]
